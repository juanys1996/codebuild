...
public class JobContext implements Context {
    ...
    private String awsRequestId = Constantes.VACIO;
    private ClientContext clientContext;
    private String functionName = Constantes.VACIO;
    private CognitoIdentity identity;
    private String logGroupName = Constantes.VACIO;
    private String logStreamName = Constantes.VACIO;
    private LambdaLogger logger = new TestLogger();
    private int memoryLimitInMB = 128;
    private int remainingTimeInMillis = 15000;
    private String functionVersion = Constantes.VACIO;
    private String invokedFunctionArn = Constantes.VACIO;
